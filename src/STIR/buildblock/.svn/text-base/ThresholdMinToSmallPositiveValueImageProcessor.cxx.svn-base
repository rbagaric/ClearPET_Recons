//
// $Id: ThresholdMinToSmallPositiveValueImageProcessor.cxx,v 1.8 2004/07/06 16:49:34 kris Exp $
//
/*!
  ...
  $Date: 2004/07/06 16:49:34 $
  $Revision: 1.8 $
*/
/*
    Copyright (C) 2000- $Date: 2004/07/06 16:49:34 $, Hammersmith Imanet Ltd
