//
// $Id: KeyParser.cxx,v 1.33 2005/03/25 17:26:46 kris Exp $
//
/*
    Copyright (C) 2000 PARAPET partners
    Copyright (C) 2000- $Date: 2005/03/25 17:26:46 $, Hammersmith Imanet Ltd
...
template <>
int get_param_from_string(string& param, const string& s)
{
...
template <>
int get_vparam_from_string(vector<string>& param, const string& s)
{
