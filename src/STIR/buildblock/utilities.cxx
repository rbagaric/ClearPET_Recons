//
// $Id: utilities.cxx,v 1.22 2005/02/01 20:30:57 kris Exp $
//
/*!
  \file 
  ...
  $Date: 2005/02/01 20:30:57 $

  $Revision: 1.22 $
*/
/*
    Copyright (C) 2000 PARAPET partners
    Copyright (C) 2000- $Date: 2005/02/01 20:30:57 $, Hammersmith Imanet Ltd
		        ...
		        const char * const extension)
{
  char * location_of_dot = 
    strchr((char*)find_filename(file_in_directory_name),'.');
