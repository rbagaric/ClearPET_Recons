# 
# $Id: config.mk,v 1.11 2005/02/18 14:43:17 kris Exp $
#
# Author Kris Thielemans
# Copyright 2004- $Date: 2005/02/18 14:43:17 $ Hammersmith Imanet Ltd
...
ifeq ($(CC),gcc)
EXTRA_CFLAGS =-Wall -Wno-deprecated -I../lmf_v2.0/includes -D_FILE_OFFSET_BITS=64
#-I/home/ClearPET/charles/opt/scatterfit_AW/
endif

#** EXTRA_LINKFLAGS: for linker
#allow the user to get extra options for link time
EXTRA_LINKFLAGS=../lmf_v2.0/lib/libLMF.a -D_FILE_OFFSET_BITS=64
#/home/ClearPET/charles/opt/scatterfit_AW/libscatterfit.a
#** compiler options


#******** variables used only for ecat7
# local/config.mk can override these defaults
#LLN_INCLUDE_DIR=/home/ClearPET/charles/opt/ecat
