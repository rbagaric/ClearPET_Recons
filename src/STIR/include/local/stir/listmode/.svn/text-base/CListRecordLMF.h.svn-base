//
// $Id: CListRecordLMF.h,v 1.3 2004/05/11 19:19:54 kris Exp $
//
/*!
  \file
 ...
 /*virtual*/
  void
    get_detection_coordinates(CartesianCoordinate3D<float>& coord_1,
      ...
      { coord_1= detection_pos1; coord_2=detection_pos2; }

  bool operator == (const CListRecord& e2) const {return true;}
...
class CListTimeDataLMF
{
 public:
  ...
  inline unsigned long get_time_in_millisecs() const
    { return time;  }// TODO
  inline Succeeded set_time_in_millisecs(const unsigned long time_in_secs)//TODO
  { return Succeeded::no; }
...
public:
  ...
  inline Succeeded set_time_in_millisecs(const unsigned long time_in_secs)
    { return time_data.set_time_in_millisecs(time_in_secs); }
