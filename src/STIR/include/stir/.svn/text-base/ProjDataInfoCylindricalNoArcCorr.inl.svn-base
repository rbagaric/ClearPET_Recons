//
// $Id: ProjDataInfoCylindricalNoArcCorr.inl,v 1.8 2005/02/17 20:00:07 kris Exp $
//
/*!
  ...
  $Date: 2005/02/17 20:00:07 $
  $Revision: 1.8 $
*/
/*
    Copyright (C) 2000- $Date: 2005/02/17 20:00:07 $, Hammersmith Imanet Ltd
