//
// $Id: ecat6_utils.h,v 1.14 2005/02/17 21:02:07 kris Exp $
//
...
/*! 
  ...
  \author Larry Byars
  \author (documented by Damien Sauge)
  \author PARAPET project
  $Revision: 1.14 $
  $Date: 2005/02/17 21:02:07 $
*/
/*
...
*/
int cti_read_attn_subheader(FILE* fptr, int blknum, Attn_subheader *header_ptr);
...
/*!
  ...
  \param header_ptr       struct to fill
*/
int cti_read_norm_subheader(FILE* fptr, int blknum, Norm_subheader *header_ptr);
...
/*!
  ...
  \param header_ptr       struct to fill
*/
int	cti_read_image_subheader (FILE *fptr, int   blknum, Image_subheader *header_ptr);
/*!
...
/*!
  ...
  \param ibytes  number of bytes to write.  (should be multiple of MatBLKSIZE)
*/
...
*/
int     cti_write_image_subheader (FILE *fptr, int blknum, const Image_subheader *header_ptr);
/*!
...
/*!
  ...
  \ingroup ECAT
   ...
   \param header_ptr  header to write
*/
int     cti_write_scan_subheader (FILE *fptr, int blknum, const Scan_subheader *header_ptr);
/*!
...
*/
int     cti_write_image (FILE *fptr, long matnum, const Image_subheader *header_ptr,
...
/*!
  ...
  allocated to accomodate for this size.
*/
int     cti_write_scan (FILE *fptr, long matnum, const Scan_subheader *header_ptr,
			const short *data, int data_size);
/*!
