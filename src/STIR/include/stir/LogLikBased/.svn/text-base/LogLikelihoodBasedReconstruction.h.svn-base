//
// $Id: LogLikelihoodBasedReconstruction.h,v 1.8 2003/10/06 10:56:55 kris Exp $
//
...
/*!
  ...
  $Date: 2003/10/06 10:56:55 $
  $Revision: 1.8 $
*/
/*
    Copyright (C) 2000 PARAPET partners
    Copyright (C) 2000- $Date: 2003/10/06 10:56:55 $, Hammersmith Imanet
