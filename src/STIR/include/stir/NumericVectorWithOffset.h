//
// $Id: NumericVectorWithOffset.h,v 1.6 2005/06/03 14:56:33 kris Exp $
//
/*
    Copyright (C) 2000 PARAPET partners
    Copyright (C) 2000- $Date: 2005/06/03 14:56:33 $, Hammersmith Imanet Ltd
