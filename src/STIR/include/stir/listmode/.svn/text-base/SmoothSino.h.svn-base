#ifndef __stir_listmode_SmoothSino_H__
#define __stir_listmode_SmoothSino_H__
...
class SmoothSino : public ParsingObject
{
public:
...
protected:
  ...
  */
  ...
  shared_ptr<ProjData> norm_data_ptr;
  shared_ptr<ProjDataInfo> norm_data_info_ptr;
