#ifndef __stir_listmode_AverageSino_H__
#define __stir_listmode_AverageSino_H__
...
class AverageSino : public ParsingObject
{
public:
...
protected:
  ...
  */
  ...
  shared_ptr<ProjData> sino_data_ptr;
  shared_ptr<ProjDataInfo> sino_data_info_ptr;
