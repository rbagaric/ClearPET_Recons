#ifndef __stir_listmode_RatioAttenSino_H__
#define __stir_listmode_RatioAttenSino_H__
...
class RatioAttenSino : public ParsingObject
{
public:
...
protected:
  ...
  */
  ...
  //{@
  string blank_filename;
  string animal_filename;
  ...
  shared_ptr<ProjData> blank_data_ptr;
  shared_ptr<ProjDataInfo> blank_data_info_ptr;

  shared_ptr<ProjData> animal_data_ptr;
  shared_ptr<ProjDataInfo> animal_data_info_ptr;
