#ifndef __stir_listmode_ScattersByGaussianFitLeipzig_H__
#define __stir_listmode_ScattersByGaussianFitLeipzig_H__
...
class ScattersByGaussianFitLeipzig : public ParsingObject
{
public:
...
protected:
  ...
  */
  ...
  shared_ptr<ProjData> emis_data_ptr;
  shared_ptr<ProjDataInfo> emis_data_info_ptr;
