#ifndef __stir_listmode_SubtractSinoScatterNegA0_H__
#define __stir_listmode_SubtractSinoScatterNegA0_H__
...
class SubtractSinoScatterNegA0 : public ParsingObject
{
public:
