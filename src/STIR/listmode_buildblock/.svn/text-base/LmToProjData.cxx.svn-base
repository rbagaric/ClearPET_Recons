//
// $Id: LmToProjData.cxx,v 1.22 2005/06/02 15:08:11 kris Exp $
//
/*!
  \file 
  \ingroup listmode
  ...
  $Date: 2005/06/02 15:08:11 $
  $Revision: 1.22 $
*/
/*
    Copyright (C) 2000- $Date: 2005/06/02 15:08:11 $, Hammersmith Imanet Ltd
...
post_processing()
{
  ...
  string clearpet ("ClearPET");
  if (scanner_ptr->get_name()!=clearpet)
  {
