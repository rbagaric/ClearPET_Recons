...
#include "stir/listmode/SmoothSino.h"
...
initialise_keymap()
{
  parser.add_start_key("smooth_sino Parameters");
...
SmoothSino::
SmoothSino(const char * const par_filename)
{
  set_defaults();
  if (par_filename!=0)
    {
...
// Force du lissage
  ...
  current_frame_num = 1;
  const string output_filename = output_filename_prefix + "_smoothed";
...
// Smooth Tangential R (bin)
    for (int axial_index = norm_data_ptr->get_min_axial_pos_num(segment_index); axial_index <= norm_data_ptr->get_max_axial_pos_num(segment_index); axial_index++)
    {
      for (int view_index = norm_data_ptr->get_min_view_num(); view_index <= norm_data_ptr->get_max_view_num(); view_index++)
      {
        ...
        {
/*          if ( tangential_index > norm_data_ptr->get_min_tangential_pos_num() && tangential_index < norm_data_ptr->get_max_tangential_pos_num() )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()-1] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()+1] )/3;
            }
            else if ( tangential_index == norm_data_ptr->get_min_tangential_pos_num() )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()+1] )/2;
            }
            else if ( tangential_index == norm_data_ptr->get_max_tangential_pos_num() )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()-1] )/2;
            }
*/
            ...
            {
              int tangential_index_new = tangential_index + i;

              if ( tangential_index_new >= norm_data_ptr->get_min_tangential_pos_num() && tangential_index_new <= norm_data_ptr->get_max_tangential_pos_num() )
              {
                (*segments_out[segment_index])[view_index][axial_index][tangential_index] += segNorm[view_index][axial_index][tangential_index_new];
                counter++;
              }
            }
            if (counter != 0)
              (*segments_out[segment_index])[view_index][axial_index][tangential_index] /= counter;
        } //end tangential
      } //end view
    } //end axial
    ...
    for (int axial_index = norm_data_ptr->get_min_axial_pos_num(segment_index); axial_index <= norm_data_ptr->get_max_axial_pos_num(segment_index); axial_index++)
    {
      for (int tangential_index = norm_data_ptr->get_min_tangential_pos_num(); tangential_index <= norm_data_ptr->get_max_tangential_pos_num(); tangential_index++)
      {
        for (int view_index = norm_data_ptr->get_min_view_num(); view_index <= norm_data_ptr->get_max_view_num(); view_index++)
        {
            segNorm[view_index][axial_index][tangential_index] = (*segments_out[segment_index])[view_index][axial_index][tangential_index];
            (*segments_out[segment_index])[view_index][axial_index][tangential_index] = 0;
        } //end tangential
      } //end view
    } //end axial
...
// Smooth View (Phi)
    ...
    for (int axial_index = norm_data_ptr->get_min_axial_pos_num(segment_index); axial_index <= norm_data_ptr->get_max_axial_pos_num(segment_index); axial_index++)
    {
      for (int tangential_index = norm_data_ptr->get_min_tangential_pos_num(); tangential_index <= norm_data_ptr->get_max_tangential_pos_num(); tangential_index++)
      {
        for (int view_index = norm_data_ptr->get_min_view_num(); view_index <= norm_data_ptr->get_max_view_num(); view_index++)
        {
/*            if ( view_index > norm_data_ptr->get_min_view_num() && view_index < norm_data_ptr->get_max_view_num() )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()-1][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()+1][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] )/3;
            }
            else if ( view_index == norm_data_ptr->get_min_view_num() )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()+1][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] )/2;
            }
            else if ( view_index == norm_data_ptr->get_max_view_num() )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()-1][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] )/2;
            }
*/
            ...
            {
              int view_index_new = view_index + j;

              if ( view_index_new >= norm_data_ptr->get_min_view_num() && view_index_new <= norm_data_ptr->get_max_view_num() )
              {
                (*segments_out[segment_index])[view_index][axial_index][tangential_index] += segNorm[view_index_new][axial_index][tangential_index];
                counter++;
              }
            }
            if (counter != 0)
...
/*    for (int view_index = norm_data_ptr->get_min_view_num(); view_index <= norm_data_ptr->get_max_view_num(); view_index++)
    {
      for (int tangential_index = norm_data_ptr->get_min_tangential_pos_num(); tangential_index <= norm_data_ptr->get_max_tangential_pos_num(); tangential_index++)
      {
  	  ...
  	  {
            if ( axial_index > norm_data_ptr->get_min_axial_pos_num(segment_index) && axial_index < norm_data_ptr->get_max_axial_pos_num(segment_index) )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()-1][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()+1][bin_out.tangential_pos_num()] )/3;
            }
            else if ( axial_index == norm_data_ptr->get_min_axial_pos_num(segment_index) )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()+1][bin_out.tangential_pos_num()] )/2;
            }
            else if ( axial_index == norm_data_ptr->get_max_axial_pos_num(segment_index) )
            {
              (*segments_out[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] = ( (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()][bin_out.tangential_pos_num()] + (*segments_norm[bin_out.segment_num()])[bin_out.view_num()][bin_out.axial_pos_num()-1][bin_out.tangential_pos_num()] )/2;
            }
          }
