...
//printf("Tang %d View %d Axial %d sinoE %f\n",T,V,A,sino_E[T][A][V]);
    ...
    double sfcorr[nb_tang_max][nb_plan_max][nb_view_max];
    //double object[nb_tang_max][nb_plan_max][nb_view_max];
    double sfvec[nb_plan_max][nb_view_max];
    double gp[nb_tang_max][nb_plan_max][nb_view_max];
    //double maximoPD[nb_plan_max][nb_view_max];
    //double sfobject[1];

    double sino_E_lissT[nb_tang_max][nb_plan_max][nb_view_max];
    ...
    double centerofmass[nb_plan_max][nb_view_max];
    double sumcenterofmass[nb_plan_max][nb_view_max];
