//
// $Id: ForwardProjectorByBinUsingRayTracing.cxx,v 1.13 2004/10/24 12:31:29 kris Exp $
//
/*!
  \file
  \ingroup projection
  ...
  $Date: 2004/10/24 12:31:29 $
  $Revision: 1.13 $
*/
/*
    Copyright (C) 2000 PARAPET partners
    Copyright (C) 2000- $Date: 2004/10/24 12:31:29 $, Hammersmith Imanet Ltd
