...
#define _PROTOTYPE_LMF_H
  ...
  ****************************/
  ...
  /***************************
       generateGDR.c
  ****************************/
  struct LMF_ccs_gateDigiRecord (*generateGDR(ENCODING_HEADER *pEncoH,
  ...
  ****************************/
  ...
  void outputCoincidence(ENCODING_HEADER *pEncoHC,
			 EVENT_HEADER *pEHC,
			 GATE_DIGI_HEADER *pGDHC,
			 CURRENT_CONTENT *pcCC,   
			 EVENT_RECORD *pERC,
  ...
  ****************************/
  ...
  FILE (*LMFCbuilder(ENCODING_HEADER *pEncoH,
		     EVENT_HEADER *pEH,      
		     GATE_DIGI_HEADER *pGDH,      
		     CURRENT_CONTENT *pcC,   
		     EVENT_RECORD *pER,      
  ...
  ****************************/
  ...
  void setEnergyCalib(char energyCalibFile[40], int nbl, int nbc, int nbsm, int nbm, int nbrs);
  ...
  ****************************/
  EVENT_RECORD *readOneEventRecord(u8 *,u16,EVENT_HEADER *,u16);
  void destroyERreader();

  /***************************
    readOneCountRateRecord.c
  ****************************/
  COUNT_RATE_RECORD *readOneCountRateRecord(ENCODING_HEADER *,
					    u8 *, u16);
  ...
  ****************************/
  u8 firstHalfOf(u8);
  u8 secondHalfOf(u8);
  struct LMF_ccs_gateDigiRecord *readOneGateDigiRecord(u8 *,u16,
						       GATE_DIGI_HEADER *,
						       EVENT_HEADER *);

  void destroyGDRreader(GATE_DIGI_RECORD *);
  ...
  ****************************/
  ...
  int diffRsectorER(EVENT_RECORD *,EVENT_RECORD *,const ENCODING_HEADER *);
  ...
  ****************************/
  ...
  u64 getTimeOfFlightOfThisCOINCI(const EVENT_RECORD *);
  ...
  ****************************/
  ...
  void init_findXYZinLMFfile(FILE *pfCCS,
			     ENCODING_HEADER *pEncoH);
  ...
  ****************************/
  ...
  void shiftTime(const ENCODING_HEADER *,
		 EVENT_RECORD *);
  ...
  ****************************/
  ...
  void geometrySelector(const ENCODING_HEADER *,
			EVENT_RECORD **);
