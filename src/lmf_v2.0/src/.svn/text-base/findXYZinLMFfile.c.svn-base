...
static u16 Epattern=0,CRpattern=0,GDpattern=0,pattern=0,sizeGD=0,sizeE=0,sizeCR=0, testread=0;
static u8 uni8=0;
...
void init_findXYZinLMFfile(FILE *pfCCS,struct LMF_ccs_encodingHeader *pEncoH)
{
...
void destroy_findXYZinLMFfile(struct LMF_ccs_encodingHeader *pEncoH)
{
