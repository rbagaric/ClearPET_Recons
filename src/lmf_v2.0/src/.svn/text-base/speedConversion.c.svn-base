...
int speedConversion(int cch_index,int dataType ){
  ...
  double result_numerator_prefix_conversion=0,result_denominator_prefix_conversion=0;
 
  content_data_unit content_data={0},
		    numerator_unit={0},
		    denominator_unit={0},
		    numerator_default_unit={0},
		    denominator_default_unit={0};

  result_unit_conversion result_numerator_conversion={0},
			 result_denominator_conversion={0};
			 
  complex_unit_type complex_unit={""}, 
                    complex_default_unit={""};
  ...
  strcpy(default_unit_file,DEFAULT_UNITS_FILE);
   ...
   if(strcmp(complex_unit.numerator,"error")==0){
     printf(ERROR11,plist_cch[cch_index].field,plist_cch[cch_index].def_unit);
   ...
   numerator_default_unit=definePrefixAndUnit(complex_default_unit.numerator,dataType);
   ...
   result_numerator_prefix_conversion=findPrefixConversionFactor(numerator_unit,numerator_default_unit);
   ...
   result_numerator_conversion=findUnitConversionFactor(numerator_unit,numerator_default_unit,dataType);
   
   dataType=5;
   denominator_unit=definePrefixAndUnit(complex_unit.denominator,dataType);
   ...
   denominator_default_unit=definePrefixAndUnit(complex_default_unit.denominator,dataType);
   ...
   result_denominator_prefix_conversion=findPrefixConversionFactor(denominator_unit,denominator_default_unit);
   ...
   result_denominator_conversion=findUnitConversionFactor(denominator_unit,denominator_default_unit,dataType);
