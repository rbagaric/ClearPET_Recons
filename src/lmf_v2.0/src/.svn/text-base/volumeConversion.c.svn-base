...
int volumeConversion(int cch_index,int dataType ){
  ...
  strcpy(surface_volume_unit,modifySurfaceOrVolumeFormat(plist_cch[cch_index].unit,dataType,"3"));
  ...
  strcpy(surface_volume_default_unit,modifySurfaceOrVolumeFormat(plist_cch[cch_index].def_unit,dataType,"3"));
  
  if(strcmp(surface_volume_default_unit,"error")==0){
    printf(ERROR14,plist_cch[cch_index].field,plist_cch[cch_index].def_unit);
