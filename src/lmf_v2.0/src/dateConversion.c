...
int dateConversion(int cch_index){
  ...
  result_date=modifyDateFormat(plist_cch[cch_index].data,plist_cch[cch_index].field);
  ...
  plist_cch[cch_index].def_unit_value.tps_date.tm_mday= plist_cch[cch_index].value.tps_date.tm_mday;
  plist_cch[cch_index].def_unit_value.tps_date.tm_mon= plist_cch[cch_index].value.tps_date.tm_mon;
  plist_cch[cch_index].def_unit_value.tps_date.tm_year= plist_cch[cch_index].value.tps_date.tm_year;
