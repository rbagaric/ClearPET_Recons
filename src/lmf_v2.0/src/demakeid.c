...
{   
  ...
  bitsShiftSubmodule = pEncoH->scanEncodingID.bitForCrystals + bitsShiftCrystal;
  bitsShiftModule =  pEncoH->scanEncodingID.bitForSubmodules + bitsShiftSubmodule;
  ...
  /*   C  */
  pcrist[1] = ((id >> bitsShiftCrystal) & (pEncoH->scanEncodingID.maximumCrystals-1));

  /*  sM  */
  pcrist[2] = ((id >> bitsShiftSubmodule) & (pEncoH->scanEncodingID.maximumSubmodules-1));

  /*   M  */
  pcrist[3] = ((id >>  bitsShiftModule) & (pEncoH->scanEncodingID.maximumModules-1));

  /* S  */
  pcrist[4] = ((id >> bitsShiftSector) & (pEncoH->scanEncodingID.maximumRsectors-1));
