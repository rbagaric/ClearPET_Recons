	      ...
	      const COUNT_RATE_HEADER *pCRH)
{
 ...
 printf("* RSECTOR : %d bits. Max = %d\n",pEncoH->scanEncodingID.bitForRsectors,pEncoH->scanEncodingID.maximumRsectors);
 printf("* MODULE : %d bits. Max = %d\n",pEncoH->scanEncodingID.bitForModules,pEncoH->scanEncodingID.maximumModules);
 printf("* SUBMODULE : %d bits. Max = %d\n",pEncoH->scanEncodingID.bitForSubmodules,pEncoH->scanEncodingID.maximumSubmodules);
 printf("* CRYSTAL : %d bits. Max = %d\n",pEncoH->scanEncodingID.bitForCrystals,pEncoH->scanEncodingID.maximumCrystals);
 printf("* LAYER : %d bits. Max = %d\n",pEncoH->scanEncodingID.bitForLayers,pEncoH->scanEncodingID.maximumLayers);
