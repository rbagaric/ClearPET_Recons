...
coordinates locateRsectorInLaboratory(u16 *pcrist,
  ...
  rotationAngle=(double)((double)rsectorID.tangential
			  *(pScanGeo->rsectorAzimuthalPitch*angleDefaultUnitToRadConversionFactor));
  ...
  centerOfTheFirstRowOfCrystals=locateSubstructureInStructure(pFirstRowOfCrystalsIDs,
							      1,
