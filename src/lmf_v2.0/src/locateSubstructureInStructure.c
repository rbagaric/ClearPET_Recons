...
coordinates locateSubstructureInStructure (u16 *pcrist, 
  ...
  double *pTangentialPitch=NULL, *pAxialPitch=NULL, *pTangentialNumberOfSubstructures=NULL, *pAxialNumberOfSubstructures=NULL;
  ...
  while(substructureOrder<4){
    ...
    structureFrame.tangential +=(double)(pTangentialPitch[substructureOrder]*(substructureID.tangential 
									      -(0.5)*(pTangentialNumberOfSubstructures[substructureOrder]-1)));
    
    structureFrame.axial +=(double)(pAxialPitch[substructureOrder]*(substructureID.axial 
