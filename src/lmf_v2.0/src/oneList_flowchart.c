...
void fcWAY_1Y(LIST *plistP1fromStart,EVENT_RECORD *pERinFromStart)
{
 ...
 tTail = getTimeOfThisEVENT((EVENT_RECORD*)dlist_tail(plistP1)->data);
  ...
  if(verboseLevel) printf("Diamond 2\n");
  /****************************************
...
void fcWAY_2N(void)
{
  ...
  if(verboseLevel) printf("Diamond 10\n");
  /****************************************
  ...
  *****************************************/
  tTail_prev = getTimeOfThisEVENT((EVENT_RECORD*)dlist_tail(plistP1)->prev->data);
...
void fcWAY_2Y(void)
{
  ...
  if(verboseLevel) printf("Diamond 3\n");
  /****************************************
...
void fcWAY_3N(void)
{
 ...
 if(verboseLevel) printf("Diamond 6\n");
 /****************************************
...
void fcWAY_3Y(void) /* // after cleaning */
{
  if(verboseLevel)  printf("Diamond 4\n");
  /****************************************
...
void fcWAY_6N(void) 
{
  ...
  tHead_next = getTimeOfThisEVENT((EVENT_RECORD*)dlist_head(plistP1)->next->data);

  if(verboseLevel) printf("Diamond 9\n");
  /****************************************
...
void fcWAY_6Y(void) 
{
  ...
  if(verboseLevel) printf("Diamond 7\n");
  /****************************************
...
void fcWAY_7Y(void) 
{
 ...
 /*  // else nothing */
  ...
  if(verboseLevel) printf("Diamond 11\n");
  /****************************************
