  ...
  if (strcmp("treatAndCopy",processingMode)==0)
    {
      ...
      */
      ...
      if(pER)
	LMFbuilder(pEncoH,pEH,pCRH,pGDH,pcC,pER,pCRR,&pf,bis_ccsFileName);
...
*/
  ...
  if (strcmp("sortBlocks",processingMode)==0)
      ...
      if(pcC->typeOfCarrier == pEncoH->scanContent.eventRecordTag)
	{
	  if (pEH->coincidenceBool == TRUE)
	    ...
	    sortBlocks(pEncoH,pEH,pCRH,pGDH,pcC,pER,pCRR,bis_ccsFileName);
	}
    }
  ...
  if (strcmp("correctDaqTime",processingMode)==0)
	...
	correctDaqTime(pEncoH,pEH,pCRH,pGDH,pcC,pER,pCRR,bis_ccsFileName);
    }
  ...
  if (strcmp("5rings",processingMode)==0)
    {
      ...
      if(pER)
	LMFbuilder(pEncoHC,pEH,pCRH,pGDH,pcC,pER,pCRR,&pf,bis_ccsFileName);
    }
}
