...
int timeConversion(int cch_index){
  ...
  result_time=modifyTimeFormat(plist_cch[cch_index].data, plist_cch[cch_index].field);
  ...
  plist_cch[cch_index].def_unit_value.tps_date.tm_sec= plist_cch[cch_index].value.tps_date.tm_sec;
  plist_cch[cch_index].def_unit_value.tps_date.tm_min= plist_cch[cch_index].value.tps_date.tm_min;
  plist_cch[cch_index].def_unit_value.tps_date.tm_hour= plist_cch[cch_index].value.tps_date.tm_hour;
